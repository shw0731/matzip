			...
			<div class="card w-100">
				<div class="card-body" style="text-align: left">
					...
					<span style="font-size: 25pt" class="Sunflower"> <s:property value="restResultClass.restaurantName" /></span> &nbsp;<input
						...
						<small><s:property value="restResultClass.likes" /></small><br>
						 <span class="star-prototype"><s:property value="restResultClass.starPoint"/></span> (<s:property value="restResultClass.starPoint"/>)
    ...
    <div class="input-group input-group-lg"  >
     ...
     <!-- starPoint -->
        ...
        <span class="starPoint">
 		 <span class="input">
  		<input type="radio" name="starPoint" id="p2" value="1"><label for="p2">1</label>
	    <input type="radio" name="starPoint" id="p4" value="2"><label for="p4">2</label>
	    <input type="radio" name="starPoint" id="p6" value="3"><label for="p6">3</label>
	    <input type="radio" name="starPoint" id="p8" value="4"><label for="p8">4</label>
	    <input type="radio" name="starPoint" id="p10" value="5"><label for="p10">5</label>
 		 </span>
  <output for="starPoint"><b></b>점</output>
</span>
...
var starRating = function(){
  ...
  $(document)
    .on("focusin", ".starPoint>.input", function(){
    $(this).addClass("focus");
  })
