...
<div class="container-b">
  <input type="checkbox" id="Checkbox" name="filter_address">
  <label for="Checkbox">
  ...
  <input type="checkbox" id="Checkbox2" name="filter_address">
  <label for="Checkbox2">
  ...
  <input type="checkbox" id="Checkbox3" name="filter_address">
  <label for="Checkbox3">
  ...
  <input type="checkbox" id="Checkbox4" name="filter_address">
  <label for="Checkbox4">
  ...
  <input type="checkbox" id="Checkbox5" name="filter_address">
  <label for="Checkbox5">
   ...
   <input type="checkbox" id="Checkbox6" name="filter_address">
  <label for="Checkbox6">
...
카테고리 별
<div class="container-b">
  <input type="checkbox" id="Checkbox7" name="filter_address">
  <label for="Checkbox7">
  ...
  <input type="checkbox" id="Checkbox8" name="filter_address">
  <label for="Checkbox8">
  ...
  <input type="checkbox" id="Checkbox9" name="filter_address">
  <label for="Checkbox9">
  ...
  <input type="checkbox" id="Checkbox10" name="filter_address">
  ...
  <input type="checkbox" id="Checkbox11" name="filter_address">
  <label for="Checkbox11">
   ...
   <input type="checkbox" id="Checkbox12" name="filter_address">
